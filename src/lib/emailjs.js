...
export async function sendEmail(params) {
    try {
        ...
        const response = await emailjs.send(EMAILJS_CONFIG.serviceId, params.templateId, templateParams);
...
export async function sendApplicationConfirmation(candidateName, candidateEmail, position) {
    return sendEmail({
...
export async function sendPhoneInterviewInvite(candidateName, candidateEmail, position, interviewDate, interviewTime) {
    return sendEmail({
...
export async function sendRejection(candidateName, candidateEmail, position) {
    return sendEmail({
...
export async function sendCustomEmail(candidateName, candidateEmail, subject, message, additionalInfo) {
    return sendEmail({
