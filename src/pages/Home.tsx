// [Content of the fully updated Home.tsx component with the mirrored design]
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-gray-900">Viva Therapies</span>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">About Viva Therapies</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-gray-900">Elite Clientele</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-gray-900">High Earnings</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-gray-900">Flexibility & Control</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-gray-900">Trusted Luxury Brand</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-gray-900">Ongoing Support</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-lg bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900">Office Portal</CardTitle>
            ...
            <Card className="border-0 shadow-lg bg-white rounded-xl">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900">Candidate Portal</CardTitle>
                <CardDescription className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/verify-email-candidate" className="hover:text-white transition-colors">Track Application</Link></li>
              </ul>
            </div>
            <div>
